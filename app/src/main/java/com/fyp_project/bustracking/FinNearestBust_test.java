...
public class FinNearestBust_test extends FragmentActivity implements OnMapReadyCallback {
...
//                    LatLng latLngEnd = new LatLng(Double.parseDouble(latitude), Double.parseDouble(longitude));
                    ...
                    geocoder = new Geocoder(FinNearestBust_test.this, Locale.getDefault());
                    ...
                    airLocation = new AirLocation(FinNearestBust_test.this, true, true, new AirLocation.Callbacks() {
                        @Override
...
//                            LatLng latLngStart = new LatLng(userx, usery);
                            ...
                            geocoderUser = new Geocoder(FinNearestBust_test.this, Locale.getDefault());
                            try {
...
//                            Toast.makeText(FinNearestBust_test.this, "+"+latLng.toString(), Toast.LENGTH_LONG).show();
  //                          Toast.makeText(FinNearestBust_test.this, "_" + latLngStart, Toast.LENGTH_LONG).show();
...
//        }
        ...
        estimatedDistance.setText("Distance (to bus) : " + distance);
        estimatedTime.setText("Estimated Time (to bus) : " + duration);
