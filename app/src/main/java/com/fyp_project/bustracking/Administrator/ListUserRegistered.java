...
public class ListUserRegistered extends AppCompatActivity {
    ...
    private void DataloadRecyclerView() {
        ...
        RecyclerAdapterListStudentRegistered recyclerAdapter = new RecyclerAdapterListStudentRegistered(list, ListUserRegistered.this, userType);
    ...
    private void searchUser(String newText) {
        ...
        for (ProfileInfo object : list) {
            ...
            RecyclerAdapterListStudentRegistered recyclerAdapterListStudentRegistered = new RecyclerAdapterListStudentRegistered(mylist, ListUserRegistered.this,userType);
