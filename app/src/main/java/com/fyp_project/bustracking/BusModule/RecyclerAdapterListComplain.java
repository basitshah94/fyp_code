...
public class RecyclerAdapterListComplain extends RecyclerView.Adapter<RecyclerAdapterListComplain.MyHoder> {
    ...
    public RecyclerAdapterListComplain(List<ProfileInfo> list, Context context, String userType) {
        this.list = list;
