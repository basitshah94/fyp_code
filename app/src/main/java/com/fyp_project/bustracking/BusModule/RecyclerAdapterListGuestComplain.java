...
public class RecyclerAdapterListGuestComplain extends RecyclerView.Adapter<RecyclerAdapterListGuestComplain.MyHoder> {
    ...
    public RecyclerAdapterListGuestComplain(List<ProfileInfo> list, Context context, String userType) {
        this.list = list;
                ...
                builder.setMessage
                        (
                                "Email : " + mylist.getUser_email() + "\n"
                                        + "Complain : " + mylist.getUser_account_status()
                        )
                        .setCancelable(false)
