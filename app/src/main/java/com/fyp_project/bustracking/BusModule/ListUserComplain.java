...
public class ListUserComplain extends AppCompatActivity {
    ...
    private void DataloadRecyclerView() {
        ...
        RecyclerAdapterListComplain recyclerAdapter = new RecyclerAdapterListComplain(list, ListUserComplain.this, userType);
    ...
    private void searchUser(String newText) {
        ...
        for (ProfileInfo object : list) {
            ...
            RecyclerAdapterListComplain recyclerAdapterListStudentRegistered = new RecyclerAdapterListComplain(mylist, ListUserComplain.this,userType);
